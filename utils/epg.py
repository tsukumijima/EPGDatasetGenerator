...
def RemoveSymbols(string: str) -> str:
    ...
    result = re.sub(r'^アニメ・', '', result)
    result = re.sub(r'^アニメ「(.*?)」', r'\1 ', result)
    result = re.sub(r'^アニメ『(.*?)』', r'\1 ', result)
    result = re.sub(r'^アニメ\d{1,2}・', '', result)
    result = re.sub(r'^アニメ\d{1,2}', '', result)
    result = re.sub(r'^テレビアニメ ', '', result)
    result = re.sub(r'^テレビアニメ・', '', result)
    result = re.sub(r'^テレビアニメ「(.*?)」', r'\1 ', result)
    result = re.sub(r'^テレビアニメ『(.*?)』', r'\1 ', result)
    result = re.sub(r'^TVアニメ ', '', result)
    result = re.sub(r'^TVアニメ・', '', result)
    result = re.sub(r'^TVアニメ「(.*?)」', r'\1 ', result)
    result = re.sub(r'^TVアニメ『(.*?)』', r'\1 ', result)
    result = re.sub(r'^ドラマ ', '', result)
    result = re.sub(r'^ドラマ・', '', result)
    result = re.sub(r'^ドラマ「(.*?)」', r'\1 ', result)
    result = re.sub(r'^ドラマ『(.*?)』', r'\1 ', result)
    result = re.sub(r'^ドラマシリーズ ', '', result)
    result = re.sub(r'^ドラマシリーズ・', '', result)
    result = re.sub(r'^ドラマシリーズ「(.*?)」', r'\1 ', result)
    result = re.sub(r'^ドラマシリーズ『(.*?)』', r'\1 ', result)
    ...
    result = re.sub(r'^ドラマ(\+|パラビ|Paravi|NEXT|プレミア\d{1,2}|チューズ！|ホリック！|ストリーム)・', '', result)
    result = re.sub(r'^ドラマ(\+|パラビ|Paravi|NEXT|プレミア\d{1,2}|チューズ！|ホリック！|ストリーム)「(.*?)」', r'\1 ', result)
    result = re.sub(r'^ドラマ(\+|パラビ|Paravi|NEXT|プレミア\d{1,2}|チューズ！|ホリック！|ストリーム)『(.*?)』', r'\1 ', result)
    result = re.sub(r'^ドラマ(\+|パラビ|Paravi|NEXT|プレミア\d{1,2}|チューズ！|ホリック！|ストリーム)', '', result)
    ...
    result = re.sub(r'^(月|火|水|木|金|土|日)(ドラ|曜劇場|曜ドラマ|曜ドラマDEEP|曜ナイトドラマ)・', '', result)
    result = re.sub(r'^(月|火|水|木|金|土|日)(ドラ|曜劇場|曜ドラマ|曜ドラマDEEP|曜ナイトドラマ)「(.*?)」', r'\1 ', result)
    result = re.sub(r'^(月|火|水|木|金|土|日)(ドラ|曜劇場|曜ドラマ|曜ドラマDEEP|曜ナイトドラマ)『(.*?)』', r'\1 ', result)
    result = re.sub(r'^(月|火|水|木|金|土|日)(ドラ|曜劇場|曜ドラマ|曜ドラマDEEP|曜ナイトドラマ)\d{1,2}・', '', result)
    result = re.sub(r'^(月|火|水|木|金|土|日)(ドラ|曜劇場|曜ドラマ||曜ドラマDEEP曜ナイトドラマ)\d{1,2}', '', result)
    result = re.sub(r'^(真夜中ドラマ|シンドラ|ドラマL|Zドラマ|よるおびドラマ) ', '', result)
    result = re.sub(r'^(真夜中ドラマ|シンドラ|ドラマL|Zドラマ|よるおびドラマ)・', '', result)
    result = re.sub(r'^(真夜中ドラマ|シンドラ|ドラマL|Zドラマ|よるおびドラマ)「(.*?)」', r'\1 ', result)
    result = re.sub(r'^(真夜中ドラマ|シンドラ|ドラマL|Zドラマ|よるおびドラマ)『(.*?)』', r'\1 ', result)
    ...
    result = re.sub(r'^韓ドラ ', '', result)
    result = re.sub(r'^韓ドラ・', '', result)
    result = re.sub(r'^韓ドラ「(.*?)」', r'\1 ', result)
    result = re.sub(r'^韓ドラ『(.*?)』', r'\1 ', result)
    result = re.sub(r'^(台湾|タイ)ドラマ ', '', result)
    result = re.sub(r'^(台湾|タイ)ドラマ・', '', result)
    result = re.sub(r'^(台湾|タイ)ドラマ「(.*?)」', r'\1 ', result)
    result = re.sub(r'^(台湾|タイ)ドラマ『(.*?)』', r'\1 ', result)
    result = re.sub(r'^韓(★|☆|◆|◇)', '', result)
    result = re.sub(r'^韓ドラ(★|☆|◆|◇)', '', result)
    ...
    result = re.sub(r'^韓流プレミア「(.*?)」', r'\1 ', result)
    result = re.sub(r'^韓流プレミア『(.*?)』', r'\1 ', result)
    result = re.sub(r'^(中|韓)(国|国BL|国歴史|流|流BL)ドラマ ', '', result)
    result = re.sub(r'^(中|韓)(国|国BL|国歴史|流|流BL)ドラマ・', '', result)
    result = re.sub(r'^(中|韓)(国|国BL|国歴史|流|流BL)ドラマ「(.*?)」', r'\1 ', result)
    result = re.sub(r'^(中|韓)(国|国BL|国歴史|流|流BL)ドラマ『(.*?)』', r'\1 ', result)
    result = re.sub(r'^(中|韓)(国|国BL|国歴史|流|流BL)ドラマ【(.*?)】', r'\1 ', result)
    ...
    result = re.sub(r'^時代劇 ', '', result)
    result = re.sub(r'^時代劇・', '', result)
    result = re.sub(r'^時代劇「(.*?)」', r'\1 ', result)
    result = re.sub(r'^時代劇『(.*?)』', r'\1 ', result)
    result = re.sub(r'^(中|韓)(国|流|国ファンタジー)時代劇 ', '', result)
    result = re.sub(r'^(中|韓)(国|流|国ファンタジー)時代劇・', '', result)
    result = re.sub(r'^(中|韓)(国|流|国ファンタジー)時代劇「(.*?)」', r'\1 ', result)
    result = re.sub(r'^(中|韓)(国|流|国ファンタジー)時代劇『(.*?)』', r'\1 ', result)
    result = re.sub(r'^(月|火|水|木|金|土|日)[0-9]「(.*?)」', r'\1 ', result)
    result = re.sub(r'^(月|火|水|木|金|土|日)[0-9]『(.*?)』', r'\1 ', result)
